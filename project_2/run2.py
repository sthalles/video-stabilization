...
if __name__ == "__main__":
    ...
    while (cap.isOpened()):
        ...
        if frame is not None:
            ...
            HsRt = convert_affine_to_scale_rotation_trainlation_transform(H.T)
            ...
            corrected_frame = affine(last_frame.astype(int), H[0:2, 0:3], current_frame.shape)
            #H0 = H

            cv2.imshow('frame', last_frame)
            #cv2.imshow('corrected', corrected_frame)

            scipy.misc.imsave("%07d.jpg" % count, corrected_frame)
